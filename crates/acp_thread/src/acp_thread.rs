...
use gpui::{
    ActivityGuard, AppContext, AsyncApp, Context, Entity, EventEmitter, Global, SharedString,
        ...
        Some(cx.spawn(async move |this, cx| {
            ...
            if outcome == SteerOutcome::Injected {
                this.update(cx, |this, cx| {
                    ...
                    let path_style = this.project.read(cx).path_style(cx);
                    let mut block = MessageContent::default();
                    for chunk in message.iter().cloned() {
